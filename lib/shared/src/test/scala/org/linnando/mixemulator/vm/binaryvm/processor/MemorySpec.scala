...
class MemorySpec extends AsyncWordSpec with Matchers {
  ...
  "binary loading from memory" when {
    "loading to register A" should {
      "load the whole word" in {
        ...
        binary.execute(state, MixWord(0x1f400148)) map {
      ...
      "load the whole word except for the sign as a positive number" in {
        ...
        binary.execute(state, MixWord(0x1f400348)) map {
      ...
      "load a right-hand part as a positive number" in {
        ...
        binary.execute(state, MixWord(0x1f400748)) map {
      ...
      "load a left-hand part with the sign and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f4000c8)).map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400248)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400908)) map {
      ...
      "load the sign only" in {
        ...
        binary.execute(state, MixWord(0x1f400008)) map {
      ...
      "load with negation the whole word" in {
        ...
        binary.execute(state, MixWord(0x1f400150)) map {
          _.registers.getA mustEqual MixWord(0x01403144)
        }
      }
      ...
      "load with negation the whole word except for the sign as a negative number" in {
        ...
        binary.execute(state, MixWord(0x1f400350)) map {
          _.registers.getA mustEqual MixWord(0x41403144)
        }
      }
      ...
      "load with negation a right-hand part as a negative number" in {
        ...
        binary.execute(state, MixWord(0x1f400750)) map {
      ...
      "load with negation a left-hand part with the sign, shift it right, and invert the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4000d0)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400250)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400910)) map {
      ...
      "load with negation the sign only and invert the sign" in {
        ...
        binary.execute(state, MixWord(0x1f400010)) map {
    ...
    "loading to register I1" should {
      "load the left-hand part of an index register size" in {
        ...
        binary.execute(state, MixWord(0x1f400089)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400909)) map {
      ...
      "load the sign only" in {
        ...
        binary.execute(state, MixWord(0x1f400009)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400249)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400911)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        binary.execute(state, MixWord(0x1f400011)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400251)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f400151))
        }
      }
    }
    ...
    "loading to register I2" should {
      "load the left-hand part of an index register size" in {
        ...
        binary.execute(state, MixWord(0x1f40008a)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40090a)) map {
      ...
      "load the sign only" in {
        ...
        binary.execute(state, MixWord(0x1f40000a)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40024a)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f40014a))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 18 LD2N
        binary.execute(state, MixWord(0x1f400092)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400912)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        binary.execute(state, MixWord(0x1f400012)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400252)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f400152))
        }
      }
    }
    ...
    "loading to register I3" should {
      "load the left-hand part of an index register size" in {
        ...
        binary.execute(state, MixWord(0x1f40008b)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40090b)) map {
      ...
      "load the sign only" in {
        ...
        binary.execute(state, MixWord(0x1f40000b)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40024b)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f40014b))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 19 LD3N
        binary.execute(state, MixWord(0x1f400093)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400913)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        binary.execute(state, MixWord(0x1f400013)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400253)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f400153))
        }
      }
    }
    ...
    "loading to register I4" should {
      "load the left-hand part of an index register size" in {
        ...
        binary.execute(state, MixWord(0x1f40008c)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40090c)) map {
      ...
      "load the sign only" in {
        ...
        binary.execute(state, MixWord(0x1f40000c)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40024c)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f40014c))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 20 LD4N
        binary.execute(state, MixWord(0x1f400094)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400914)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        binary.execute(state, MixWord(0x1f400014)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400254)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f400154))
        }
      }
    }
    ...
    "loading to register I5" should {
      "load the left-hand part of an index register size" in {
        ...
        binary.execute(state, MixWord(0x1f40008d)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40090d)) map {
      ...
      "load the sign only" in {
        ...
        binary.execute(state, MixWord(0x1f40000d)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40024d)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f40014d))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 21 LD5N
        binary.execute(state, MixWord(0x1f400095)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400915)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        binary.execute(state, MixWord(0x1f400015)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400255)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f400155))
        }
      }
    }
    ...
    "loading to register I6" should {
      "load the left-hand part of an index register size" in {
        ...
        binary.execute(state, MixWord(0x1f40008e)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40090e)) map {
      ...
      "load the sign only" in {
        ...
        binary.execute(state, MixWord(0x1f40000e)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40024e)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f40014e))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 22 LD6N
        binary.execute(state, MixWord(0x1f400096)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400916)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        binary.execute(state, MixWord(0x1f400016)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400256)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x1f400156))
        }
      }
    }
    ...
    "loading to register X" should {
      "load the whole word" in {
        ...
        binary.execute(state, MixWord(0x1f40014f)) map {
      ...
      "load the whole word except for the sign as a positive number" in {
        ...
        binary.execute(state, MixWord(0x1f40034f)) map {
      ...
      "load a right-hand part as a positive number" in {
        ...
        binary.execute(state, MixWord(0x1f40074f)) map {
      ...
      "load a left-hand part with a sign and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f4000cf)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40024f)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f40090f)) map {
      ...
      "load the sign only" in {
        ...
        binary.execute(state, MixWord(0x1f40000f)) map {
      ...
      "load with negation the whole word" in {
        ...
        binary.execute(state, MixWord(0x1f400157)) map {
          _.registers.getX mustEqual MixWord(0x01403144)
        }
      }
      ...
      "load with negation the whole word except for the sign as a negative number" in {
        ...
        binary.execute(state, MixWord(0x1f400357)) map {
          _.registers.getX mustEqual MixWord(0x41403144)
        }
      }
      ...
      "load with negation a right-hand part as a negative number" in {
        ...
        binary.execute(state, MixWord(0x1f400757)) map {
      ...
      "load with negation a left-hand part with the sign, shift it right, and invert the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4000d7)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400257)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        binary.execute(state, MixWord(0x1f400917)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        binary.execute(state, MixWord(0x1f400017)) map {
  ...
  "binary storing to memory" when {
    "storing from register A" should {
      "replace the whole content of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440158)) map {
      ...
      "replace the whole content of a memory cell except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f440358)) map {
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b58)) map {
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f440498)) map {
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404d8)) map {
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f440058)) map {
    ...
    "storing from register I1" should {
      "replace the whole content of a memory cell, filling lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f440159)) map {
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f440359)) map {
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b59)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41083100)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f440499)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41003105)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404d9)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41240105)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f440059)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00083105)
        }
      }
    }
    ...
    "storing from register I2" should {
      "replace the whole content of a memory cell, filling lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44015a)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x40000240)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44035a)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x40000240)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b5a)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41083100)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44049a)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41003105)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404da)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41240105)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44005a)) map {
    ...
    "storing from register I3" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44015b)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00000240)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44035b)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x40000240)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b5b)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41083100)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44049b)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41003105)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404db)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41240105)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44005b)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00083105)
        }
      }
    }
    ...
    "storing from register I4" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44015c)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00000240)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44035c)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x40000240)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b5c)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41083100)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44049c)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41003105)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404dc)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41240105)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44005c)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00083105)
        }
      }
    }
    ...
    "storing from register I5" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44015d)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00000240)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44035d)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x40000240)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b5d)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41083100)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44049d)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41003105)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404dd)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41240105)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44005d)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00083105)
        }
      }
    }
    ...
    "storing from register I6" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44015e)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00000240)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f44035e)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x40000240)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b5e)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41083100)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44049e)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41003105)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404de)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41240105)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44005e)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00083105)
        }
      }
    }
    ...
    "storing from register X" should {
      "replace the whole content of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f44015f)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x461c8240)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f44035f)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x461c8240)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b5f)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41083100)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44049f)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41003105)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404df)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41240105)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f44005f)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x40083105)
        }
      }
    }
    ...
    "storing from register J" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f440160)) map {
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        binary.execute(state, MixWord(0x1f440360)) map {
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b60)) map {
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        binary.execute(state, MixWord(0x1f4404a0)) map {
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f4404e0)) map {
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        binary.execute(state, MixWord(0x1f440060)) map {
    ...
    "storing zero" should {
      "clear the whole content of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440161)) map {
      ...
      "clear the whole content of a memory cell except for the sign" in {
        ...
        binary.execute(state, MixWord(0x1f440361)) map {
      ...
      "clear only a right-hand part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440b61)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x41083100)
        }
      }
      ...
      "clear only a middle part of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f4404e1)) map {
      ...
      "clear only a left-hand part with the sign of a memory cell" in {
        ...
        binary.execute(state, MixWord(0x1f440061)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x00083105)
        }
      }
    }
  ...
  "binary moving in memory" should {
    "move memory words" in {
      ...
      binary.execute(prevState, MixWord(0x1f4000c7)).map(s => {
    ...
    "do nothing when the number of words to move is zero" in {
      ...
      binary.execute(prevState, MixWord(0x1f400007)).map(s => {
