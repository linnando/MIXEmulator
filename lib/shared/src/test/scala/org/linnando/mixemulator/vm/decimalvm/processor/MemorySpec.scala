...
class MemorySpec extends AsyncWordSpec with Matchers {
  ...
  "decimal loading from memory" when {
    "loading to register A" should {
      "load the whole word" in {
        ...
        execute(state, MixWord(2000000508L)) map {
      ...
      "load the whole word except for the sign as a positive number" in {
        ...
        execute(state, MixWord(2000001308L)) map {
      ...
      "load a right-hand part as a positive number" in {
        ...
        execute(state, MixWord(2000002908L)) map {
      ...
      "load a left-hand part with the sign and shift it right" in {
        ...
        execute(state, MixWord(2000000308L)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000000908L)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000003608L)) map {
      ...
      "load the sign only" in {
        ...
        execute(state, MixWord(2000000008L)) map {
      ...
      "load with negation the whole word" in {
        ...
        execute(state, MixWord(2000000516L)) map {
          _.registers.getA mustEqual MixWord(116030504L)
        }
      }
      ...
      "load with negation the whole word except for the sign as a negative number" in {
        ...
        execute(state, MixWord(2000001316L)) map {
          _.registers.getA mustEqual MixWord(0x400000000L | 116030504L)
        }
      }
      ...
      "load with negation a right-hand part as a negative number" in {
        ...
        execute(state, MixWord(2000002916L)) map {
      ...
      "load with negation a left-hand part with the sign, shift it right, and invert the sign" in {
        ...
        execute(state, MixWord(2000000316L)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000000916L)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000003616L)) map {
      ...
      "load with negation the sign only and invert the sign" in {
        ...
        execute(state, MixWord(2000000016L)) map {
    ...
    "loading to register I1" should {
      "load the left-hand part of an index register size" in {
        ...
        execute(state, MixWord(2000000209L)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000003609L)) map {
      ...
      "load the sign only" in {
        ...
        execute(state, MixWord(2000000009L)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000000909L)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000003617L)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        execute(state, MixWord(2000000017L)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000000917L)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000517L))
        }
      }
    }
    ...
    "loading to register I2" should {
      "load the left-hand part of an index register size" in {
        ...
        execute(state, MixWord(2000000210L)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000003610L)) map {
      ...
      "load the sign only" in {
        ...
        execute(state, MixWord(2000000010L)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000000910L)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000510L))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 18 LD2N
        execute(state, MixWord(2000000218L)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000003618L)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        execute(state, MixWord(2000000018L)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000000918L)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000518L))
        }
      }
    }
    ...
    "loading to register I3" should {
      "load the left-hand part of an index register size" in {
        ...
        execute(state, MixWord(2000000211L)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000003611L)) map {
      ...
      "load the sign only" in {
        ...
        execute(state, MixWord(2000000011L)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000000911L)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000511L))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 19 LD3N
        execute(state, MixWord(2000000219L)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000003619L)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        execute(state, MixWord(2000000019L)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000000919L)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000519L))
        }
      }
    }
    ...
    "loading to register I4" should {
      "load the left-hand part of an index register size" in {
        ...
        execute(state, MixWord(2000000212L)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000003612L)) map {
      ...
      "load the sign only" in {
        ...
        execute(state, MixWord(2000000012L)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000000912L)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000512L))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 20 LD4N
        execute(state, MixWord(2000000220L)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000003620L)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        execute(state, MixWord(2000000020L)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000000920L)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000520L))
        }
      }
    }
    ...
    "loading to register I5" should {
      "load the left-hand part of an index register size" in {
        ...
        execute(state, MixWord(2000000213L)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000003613L)) map {
      ...
      "load the sign only" in {
        ...
        execute(state, MixWord(2000000013L)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000000913L)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000513L))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 21 LD5N
        execute(state, MixWord(2000000221L)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000003621L)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        execute(state, MixWord(2000000021L)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000000921L)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000521L))
        }
      }
    }
    ...
    "loading to register I6" should {
      "load the left-hand part of an index register size" in {
        ...
        execute(state, MixWord(2000000214L)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000003614L)) map {
      ...
      "load the sign only" in {
        ...
        execute(state, MixWord(2000000014L)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000000914L)) map {
      ...
      "throw an exception on an attempt to load a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000514L))
        }
      }

      "load with negation the left-hand part of an index register size" in {
        // A = 2000, I = 0, F = 0:2, C = 22 LD6N
        execute(state, MixWord(2000000222L)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000003622L)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        execute(state, MixWord(2000000022L)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000000922L)) map {
      ...
      "throw an exception on an attempt to load with negation a field that does not fit into an index register" in {
        recoverToSucceededIf[OverflowException] {
          ...
          execute(state, MixWord(2000000522L))
        }
      }
    }
    ...
    "loading to register X" should {
      "load the whole word" in {
        ...
        execute(state, MixWord(2000000515L)) map {
      ...
      "load the whole word except for the sign as a positive number" in {
        ...
        execute(state, MixWord(2000001315L)) map {
      ...
      "load a right-hand part as a positive number" in {
        ...
        execute(state, MixWord(2000002915L)) map {
      ...
      "load a left-hand part with a sign and shift it right" in {
        ...
        execute(state, MixWord(2000000315L)) map {
      ...
      "load a left-hand part without the sign as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000000915L)) map {
      ...
      "load a middle part as a positive number and shift it right" in {
        ...
        execute(state, MixWord(2000003615L)) map {
      ...
      "load the sign only" in {
        ...
        execute(state, MixWord(2000000015L)) map {
      ...
      "load with negation the whole word" in {
        ...
        execute(state, MixWord(2000000523L)) map {
          _.registers.getX mustEqual MixWord(116030504L)
        }
      }
      ...
      "load with negation the whole word except for the sign as a negative number" in {
        ...
        execute(state, MixWord(2000001323L)) map {
          _.registers.getX mustEqual MixWord(0x400000000L | 116030504L)
        }
      }
      ...
      "load with negation a right-hand part as a negative number" in {
        ...
        execute(state, MixWord(2000002923L)) map {
      ...
      "load with negation a left-hand part with the sign, shift it right, and invert the sign" in {
        ...
        execute(state, MixWord(2000000323L)) map {
      ...
      "load with negation a left-hand part without the sign as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000000923L)) map {
      ...
      "load with negation a middle part as a negative number and shift it right" in {
        ...
        execute(state, MixWord(2000003623L)) map {
      ...
      "load with negation the sign only and invert it" in {
        ...
        execute(state, MixWord(2000000023L)) map {
  ...
  "decimal storing to memory" when {
    "storing from register A" should {
      "replace the whole content of a memory cell" in {
        ...
        execute(state, MixWord(2001000524L)) map {
      ...
      "replace the whole content of a memory cell except for the sign" in {
        ...
        execute(state, MixWord(2001001324L)) map {
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004524L)) map {
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001824L)) map {
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001924L)) map {
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000124L)) map {
    ...
    "storing from register I1" should {
      "replace the whole content of a memory cell, filling lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001000525L)) map {
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001001325L)) map {
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004525L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 102030400L)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001825L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 100030405L)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001925L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 109000405L)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000125L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(2030405L)
        }
      }
    }
    ...
    "storing from register I2" should {
      "replace the whole content of a memory cell, filling lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001000526L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 900L)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001001326L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 900L)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004526L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 102030400L)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001826L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 100030405L)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001926L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 109000405L)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000126L)) map {
    ...
    "storing from register I3" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001000527L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(900L)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001001327L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 900L)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004527L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 102030400L)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001827L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 100030405L)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001927L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 109000405L)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000127L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(2030405L)
        }
      }
    }
    ...
    "storing from register I4" should {
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001001328L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 900L)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004528L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 102030400L)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001828L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 100030405L)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001928L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 109000405L)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000128L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(2030405L)
        }
      }
    }
    ...
    "storing from register I5" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001000529L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(900L)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001001329L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 900L)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004529L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 102030400L)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001829L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 100030405L)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001929L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 109000405L)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000129L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(2030405L)
        }
      }
    }
    ...
    "storing from register I6" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001000530L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(900L)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001001330L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 900L)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004530L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 102030400L)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001830L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 100030405L)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001930L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 109000405L)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000130L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(2030405L)
        }
      }
    }
    ...
    "storing from register X" should {
      "replace the whole content of a memory cell" in {
        ...
        execute(state, MixWord(2001000531L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 607080900L)
        }
      }
      ...
      "replace the whole content of a memory cell except for the sign" in {
        ...
        execute(state, MixWord(2001001331L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 607080900L)
        }
      }
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004531L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 102030400L)
        }
      }
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001831L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 100030405L)
        }
      }
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001931L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 109000405L)
        }
      }
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000131L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 2030405L)
        }
      }
    }
    ...
    "storing from register J" should {
      "replace the whole content of a memory cell, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001000532L)) map {
      ...
      "replace the whole content of a memory cell except for the sign, filling the lacking bytes with zeros" in {
        ...
        execute(state, MixWord(2001001332L)) map {
      ...
      "replace only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004532L)) map {
      ...
      "replace only a middle part of a memory cell with a right-hand part of the register" in {
        ...
        execute(state, MixWord(2001001832L)) map {
      ...
      "replace only a middle part of a memory cell with the whole content of the register except for the sign" in {
        ...
        execute(state, MixWord(2001001932L)) map {
      ...
      "replace only a left-hand part with the sign of a memory cell with a right-hand part and the sign of the register" in {
        ...
        execute(state, MixWord(2001000132L)) map {
    ...
    "storing zero" should {
      "clear the whole content of a memory cell" in {
        ...
        execute(state, MixWord(2001000533L)) map {
      ...
      "clear the whole content of a memory cell except for the sign" in {
        ...
        execute(state, MixWord(2001001333L)) map {
      ...
      "clear only a right-hand part of a memory cell" in {
        ...
        execute(state, MixWord(2001004533L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(0x400000000L | 102030400L)
        }
      }
      ...
      "clear only a middle part of a memory cell" in {
        ...
        execute(state, MixWord(2001001933L)) map {
      ...
      "clear only a left-hand part with the sign of a memory cell" in {
        ...
        execute(state, MixWord(2001000133L)) map {
          _.memory.get(2001.toShort) mustEqual MixWord(2030405L)
        }
      }
    }
  ...
  "decimal moving in memory" should {
    "move memory words" in {
      ...
      execute(prevState, MixWord(2000000307L)).map(s => {
    ...
    "do nothing when the number of words to move is zero" in {
      ...
      execute(prevState, MixWord(2000000007L)).map(s => {
