  ...
  "binary comparison module" when {
    "comparing register A with memory" should {
      "compare the whole word" in {
        ...
        execute(state, MixWord(0x0fa00178)) map {
      ...
      "compare the whole word except for the sign" in {
        ...
        execute(state, MixWord(0x0fa00378)) map {
      ...
      "compare a field including the sign" in {
        ...
        execute(state, MixWord(0x0fa000f8)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a left-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa002f8)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a right-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa00978)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa000b8)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field not including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa002b8)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
    }
    ...
    "comparing register I1 with memory" should {
      "compare the whole word" in {
        ...
        execute(state, MixWord(0x0fa00179)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare the whole word without the sign" in {
        ...
        execute(state, MixWord(0x0fa00379)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign" in {
        ...
        execute(state, MixWord(0x0fa000f9)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a left-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa002f9)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a right-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa00979)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a field including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa000b9)) map {
      ...
      "compare a field not including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa002b9)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
    }
    ...
    "comparing register I2 with memory" should {
      "compare the whole word" in {
        ...
        execute(state, MixWord(0x0fa0017a)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare the whole word except for the sign" in {
        ...
        execute(state, MixWord(0x0fa0037a)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign" in {
        ...
        execute(state, MixWord(0x0fa000fa)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a left-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa002fa)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a right-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa0097a)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa000ba)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
      ...
      "compare a field not including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa002ba)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
    }
    ...
    "comparing register I3 with memory" should {
      "compare the whole word" in {
        ...
        execute(state, MixWord(0x0fa0017b)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare the whole word except for the sign" in {
        ...
        execute(state, MixWord(0x0fa0037b)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign" in {
        ...
        execute(state, MixWord(0x0fa000fb)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a left-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa002fb)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a right-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa0097b)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a field including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa000bb)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
      ...
      "compare a field not including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa002bb)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
    }
    ...
    "comparing register I4 with memory" should {
      "compare the whole word" in {
        ...
        execute(state, MixWord(0x0fa0017c)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare the whole word except for the sign" in {
        ...
        execute(state, MixWord(0x0fa0037c)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign" in {
        ...
        execute(state, MixWord(0x0fa000fc)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a left-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa002fc)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a right-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa0097c)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a field including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa000bc)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
      ...
      "compare a field not including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa002bc)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
    }
    ...
    "comparing register I5 with memory" should {
      "compare the whole word" in {
        ...
        execute(state, MixWord(0x0fa0017d)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare the whole word except for the sign" in {
        ...
        execute(state, MixWord(0x0fa0037d)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign" in {
        ...
        execute(state, MixWord(0x0fa000fd)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a left-side fields not including the sign" in {
        ...
        execute(state, MixWord(0x0fa002fd)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a right-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa0097d)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa000bd)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
      ...
      "compare a field not including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa002bd)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
    }
    ...
    "comparing register I6 with memory" should {
      "compare the whole word" in {
        ...
        execute(state, MixWord(0x0fa0017e)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare the whole word except for the sign" in {
        ...
        execute(state, MixWord(0x0fa0037e)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign" in {
        ...
        execute(state, MixWord(0x0fa000fe)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a left-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa002fe)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a right-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa0097e)) map {
          _.registers.getCMP mustEqual Comparison.LESS
        }
      }
      ...
      "compare a field including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa000be)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
      ...
      "compare a field not including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa002be)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
    }
    ...
    "comparing register X with memory" should {
      "compare the whole word" in {
        ...
        execute(state, MixWord(0x0fa0017f)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare the whole word except for the sign" in {
        ...
        execute(state, MixWord(0x0fa0037f)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a field including the sign" in {
        ...
        execute(state, MixWord(0x0fa000ff)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a left-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa002ff)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
      ...
      "compare a right-side field not including the sign" in {
        ...
        execute(state, MixWord(0x0fa0097f)) map {
          _.registers.getCMP mustEqual Comparison.GREATER
        }
      }
      ...
      "compare a field including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa000bf)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
      ...
      "compare a field not including the sign to zero" in {
        ...
        execute(state, MixWord(0x0fa002bf)) map {
          _.registers.getCMP mustEqual Comparison.EQUAL
        }
      }
    }
