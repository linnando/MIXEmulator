  ...
  "binary increment module" when {
    "incrementing register A" should {
      "increment by a fixed number" in {
        ...
        binary.execute(state, MixWord(0x00040030)).map(s => {
      ...
      "increment by an indexed address" in {
        ...
        binary.execute(state, MixWord(0x00045030)).map(s => {
      ...
      "increment with an overflow" in {
        ...
        binary.execute(state, MixWord(0x07440030)).map(s => {
      ...
      "not change the overflow flag if no overflow occurs" in {
        ...
        // A = 1, I = 0, F = 0, C = 48 INCA
        binary.execute(stateWithOV, MixWord(0x00040030)) map {
      ...
      "increment by the current value's negation preserving the current sign" in {
        ...
        binary.execute(stateWithSmallA, MixWord(0x78c00030)) map {
    ...
    "incrementing register I1" should {
      "increment by a fixed number" in {
        ...
        binary.execute(state, MixWord(0x00040031)).map(s => {
      ...
      "increment by an indexed address" in {
        ...
        binary.execute(state, MixWord(0x00045031)).map(s => {
      ...
      "throw an exception on overflow" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x20f40031))
        }
      }
      ...
      "not change the overflow flag if no overflow occurs" in {
        val stateWithOV = state.copy(registers = state.registers.updatedOV(true))
        // A = 1, I = 0, F = 0, C = 49 INC1
        binary.execute(stateWithOV, MixWord(0x00040031)) map {
          _.registers.getOV mustEqual true
        }
      }
      ...
      "increment by the current value's negation preserving the current sign" in {
        ...
        binary.execute(state, MixWord(0x5f0c0031)) map {
      ...
      "incrementing register I2" should {
        "increment by a fixed number" in {
          ...
          binary.execute(state, MixWord(0x00040032)).map(s => {
        ...
        "increment by an indexed address" in {
          ...
          binary.execute(state, MixWord(0x00045032)).map(s => {
        ...
        "throw an exception on overflow" in {
          recoverToSucceededIf[OverflowException] {
            ...
            binary.execute(state, MixWord(0x1ce00032))
          }
        }
        ...
        "not change the overflow flag if no overflow occurs" in {
          val stateWithOV = state.copy(registers = state.registers.updatedOV(true))
          // A = 1, I = 0, F = 0, C = 50 INC2
          binary.execute(stateWithOV, MixWord(0x00040032)) map {
            _.registers.getOV mustEqual true
          }
        }
        ...
        "increment by the current value's negation preserving the current sign" in {
          ...
          binary.execute(state, MixWord(0x63200032)) map {
    ...
    "incrementing register I3" should {
      "increment by a fixed number" in {
        ...
        binary.execute(state, MixWord(0x00040033)).map(s => {
      ...
      "increment by an indexed address" in {
        ...
        binary.execute(state, MixWord(0x00045033)).map(s => {
      ...
      "throw an exception on overflow" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x0b5c0033))
        }
      }
      ...
      "not change the overflow flag if no overflow occurs" in {
        val stateWithOV = state.copy(registers = state.registers.updatedOV(true))
        // A = 1, I = 0, F = 0, C = 51 INC3
        binary.execute(stateWithOV, MixWord(0x00040033)) map {
          _.registers.getOV mustEqual true
        }
      }
      ...
      "increment by the current value's negation preserving the current sign" in {
        ...
        binary.execute(state, MixWord(0x74a40033)) map {
    ...
    "incrementing register I4" should {
      "increment by a fixed number" in {
        ...
        binary.execute(state, MixWord(0x00040034)).map(s => {
      ...
      "increment by an indexed address" in {
        ...
        binary.execute(state, MixWord(0x00045034)).map(s => {
      ...
      "throw an exception on overflow" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x39040034))
        }
      }
      ...
      "not change the overflow flag if no overflow occurs" in {
        val stateWithOV = state.copy(registers = state.registers.updatedOV(true))
        // A = 1, I = 0, F = 0, C = 52 INC4
        binary.execute(stateWithOV, MixWord(0x00040034)) map {
          _.registers.getOV mustEqual true
        }
      }
      ...
      "increment by the current value's negation preserving the current sign" in {
        ...
        binary.execute(state, MixWord(0x56fc0034)) map {
    ...
    "incrementing register I5" should {
      "increment by a fixed number" in {
        ...
        binary.execute(state, MixWord(0x00040035)).map(s => {
      ...
      "increment by an indexed address" in {
        ...
        binary.execute(state, MixWord(0x00045035)).map(s => {
      ...
      "throw an exception on overflow" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x3c0c0035))
        }
      }
      ...
      "not change the overflow flag if no overflow occurs" in {
        val stateWithOV = state.copy(registers = state.registers.updatedOV(true))
        // A = 1, I = 0, F = 0, C = 53 INC5
        binary.execute(stateWithOV, MixWord(0x00040035)) map {
          _.registers.getOV mustEqual true
        }
      }
      ...
      "increment by the current value's negation preserving the current sign" in {
        ...
        binary.execute(state, MixWord(0x43f40035)) map {
    ...
    "incrementing register I6" should {
      "increment by a fixed number" in {
        ...
        binary.execute(state, MixWord(0x00040036)).map(s => {
      ...
      "increment registers by an indexed address" in {
        ...
        binary.execute(state, MixWord(0x00045036)).map(s => {
      ...
      "throw an exception on overflow" in {
        recoverToSucceededIf[OverflowException] {
          ...
          binary.execute(state, MixWord(0x48740036))
        }
      }
      ...
      "not change the overflow flag if no overflow occurs" in {
        val stateWithOV = state.copy(registers = state.registers.updatedOV(true))
        // A = 1, I = 0, F = 0, C = 54 INC6
        binary.execute(stateWithOV, MixWord(0x00040036)) map {
          _.registers.getOV mustEqual true
        }
      }
      ...
      "increment by the current value's negation preserving the current sign" in {
        ...
        binary.execute(state, MixWord(0x378c0036)) map {
    ...
    "incrementing register X" should {
      "increment by a fixed number" in {
        ...
        binary.execute(state, MixWord(0x00040037)).map(s => {
      ...
      "increment registers by an indexed address" in {
        ...
        binary.execute(state, MixWord(0x00045037)).map(s => {
      ...
      "increment with an overflow" in {
        ...
        binary.execute(state, MixWord(0x6b900037)).map(s => {
      ...
      "not change the overflow flag if no overflow occurs" in {
        val stateWithOV = state.copy(registers = state.registers.updatedOV(true))
        // A = 1, I = 0, F = 0, C = 55 INCX
        binary.execute(stateWithOV, MixWord(0x00040037)) map {
          _.registers.getOV mustEqual true
        }
      }
      ...
      "increment by the current value's negation preserving the current sign" in {
        ...
        binary.execute(stateWithSmallX, MixWord(0x14700037)) map {
